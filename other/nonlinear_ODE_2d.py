...
fixpoints:  x = (0, 0) hyperbolic 
            with L = [[3, 0], [0, -1]]
            eigenvalues l1 = 3, l2 = -1
            x = (1, 2) stable spiral
            with L = [[-1, -1], [2, 0]]
            eigenvalues l1,2 = -1/2 +- i sqrt(7/4)

For x < 0, the solution always diverges towards (x, y) -> (0, -infinity).
It also diverges for x > 0, y < 0.
These cases are excluded explicitly in the case of random numbers to not generate overflow.
